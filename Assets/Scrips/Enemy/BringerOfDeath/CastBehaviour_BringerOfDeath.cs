...
public class CastBehaviour_BringerOfDeath : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        player = _bringerOfDeathBoss.Player;

        if (player != null)
        {
            _bringerOfDeathBoss.LookPlayer();

            Vector2 spawnPosition = new Vector2(player.position.x, player.position.y + offsetY);
